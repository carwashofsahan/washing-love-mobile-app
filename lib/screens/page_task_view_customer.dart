...
import 'package:washing_love/utils/page_task_customer.dart';
...
// jobs page customer
class HistoryPageCustomer extends StatefulWidget {
  final User user;
  final String token;
  HistoryPageCustomer({@required this.user, @required this.token});
  @override
  _HistoryPageCustomerState createState() =>
      _HistoryPageCustomerState(user, token);
}

class _HistoryPageCustomerState extends State<HistoryPageCustomer>
  ...
  _HistoryPageCustomerState(this.user, this.token);
